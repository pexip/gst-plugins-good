...
static void
new_rtcp_ssrc_pad_found (GstElement * element, guint ssrc, GstPad * rtp_pad,
                    GSList ** src_h)
{
  GstHarness *h;
  gchar *name;
...
GST_START_TEST (test_rtpssrcdemux_rtcp_app)
{
  ...
  fail_unless_equals_int (GST_FLOW_OK,
      gst_harness_push (h, gst_buffer_new_wrapped_full (0, rtcp_app_pkt, sizeof rtcp_app_pkt, 0, sizeof rtcp_app_pkt, NULL, NULL)));

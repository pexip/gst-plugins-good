 ...
 * RTPTWCCPacket:
 *
 * Structure to calculate Transport-wide RTCP Feedback
 */
typedef struct {
  GstClockTime ts;
...
void rtp_twcc_packet_init (RTPTWCCPacket * packet, RTPPacketInfo * pinfo);
void rtp_twcc_add_fci (GstRTCPPacket * packet, GArray * twcc_packets,
    guint8 fb_pkt_count);
